...
class ProfileViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func setupViewControllerView() {
        ...
        if screenSize.width > 320.0 {
            ...
            viewController.view.widthAnchor.constraint(equalTo: self.view.widthAnchor, constant: -6).isActive = true
            viewController.view.leftAnchor.constraint(equalTo: self.view.leftAnchor, constant: 3).isActive = true
